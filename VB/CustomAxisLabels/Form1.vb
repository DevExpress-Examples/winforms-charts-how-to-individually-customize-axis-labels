...
Namespace CustomAxisLabels
	Partial Public Class Form1
		...
		Private Sub chartControl1_CustomDrawAxisLabel(ByVal sender As Object, ByVal e As DevExpress.XtraCharts.CustomDrawAxisLabelEventArgs) Handles chartControl1.CustomDrawAxisLabel
